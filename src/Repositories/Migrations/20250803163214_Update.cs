        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumberConfirmationToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumberConfirmationTokenExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TwoFactorAuthenticationToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TwoFactorAuthenticationTokenExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
