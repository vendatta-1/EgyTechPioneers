...
) : IProjectsMaster
{
    ...
    public async Task<Result<IReadOnlyCollection<ProjectsMasterDto>>> GetAllAsync(CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Result<ProjectsMasterDto>> CreateAsync(ProjectsMasterDto dto, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Result<bool>> UpdateAsync(Guid id, ProjectsMasterDto dto, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Result<IReadOnlyCollection<ProjectsMasterDto>>> GetByAcademyIdAsync(Guid academyId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Result<IReadOnlyCollection<ProjectsMasterDto>>> GetByBranchIdAsync(Guid branchId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Result<IReadOnlyCollection<ProjectsMasterDto>>> GetByDateRangeAsync(DateOnly start, DateOnly end, CancellationToken cancellationToken = default)
    {
